PHP CodeSniffer Symfony2 Coding Standard
========================================

a code standard to check against the [Symfony coding standards](http://symfony.com/doc/current/contributing/code/standards.html), shamelessly copied from the escapestudios/Symfony2-coding-standard repository.
the sniffs and cofiguration used in this repository are slightly more strict than the ones used by escapestudios
